package com.compose.textfield.textField
    ...
    Column(
        ...
        OutlinedTextField(
            ...
            supportingText = {
                Text(
                    modifier = Modifier.fillMaxWidth(),
                    text = "Limite: ${value.length}/$charLimit",
...
private fun DefaultOutlinedTexFieldPreview(){
